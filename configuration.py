...
# Почта и пароль, с которой будет отправляться подтверждение о регистрации пользователя
EMAIL_REGISTRATOR_SENDER_NAME = ""
EMAIL_REGISTRATOR_SENDER_PASSWORD = ""

# Тема и текст письма
EMAIL_REGISTRATOR_SENDER_SUBJECT = "Подтверждение регистрации на WikiCode.ru"
EMAIL_REGISTRATOR_SENDER_TEXT = """
Вас приветствует WikiCode.ru!

Чтобы завершить регистрацию, перейдите по следующей ссылке:
"""

# POST QUERY адрес. Здесь указываем wikicode.ru или локальный адрес для тестирования
EMAIL_REGISTRATOR_POST_QUERY_ADDRESS = "http://127.0.0.1:8000/confirm_registration/"
